...
include '../Model/connect.php'; // تأكد من وجود هذا الملف الذي يحتوي على الاتصال بقاعدة البيانات

// استرجاع بيانات المسافر من الـ session
if (isset($_SESSION["currentID"])) {
    $travelerID = $_SESSION["currentID"];

    // جلب بيانات المسافر من جدول المستخدم
...
<head>
    ...
    <title>Payment</title>
    <style>
        /* الكود الخاص بـ CSS يظل كما هو من السابق */
        /* ... */
    </style>
</head>
